  ...
  return (
    ...
    <div className='w-[100%] overflow-hidden'>
      ...
      <div className='w-[100%] lg:h-[140vh] h-[70vh] relative'>
        ...
        <span className='lg:text-[100px] absolute  md:text-[50px]  lg:top-[15%] top-[15%] w-[100%] flex items-center justify-center text-white font-bold text-[20px] '>
          Grow Your Skills to Advance 
        </span>
        <span className='lg:text-[73px] text-[20px] md:text-[40px] absolute lg:top-[26%] top-[30%] w-[100%] flex items-center justify-center text-white font-bold'>
          Your Career path
        </span>
        <div className='absolute lg:top-[36%] top-[75%]  md:top-[80%] w-[100%] flex items-center justify-center gap-3 flex-wrap'>
